...
- **One-Tap Backup:** **Settings ▸ Backup ▸ Create Backup** zips every note and exports it through the system save dialog (a save panel on macOS, Files on iOS) as `DevNotes-Backup-YYYYMMDD-HHMMSS.zip`. If a backup can't be built or written, DevNotes says why in an alert rather than failing quietly.
